        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_City_NumberOfHotels_NonNegative", "[NumberOfHotels] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_Email_ValidFormat", "[Email] LIKE '_%@_%._%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerNight = table.Column<decimal>(type: "decimal(34,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Hotel_PricePerNight_NonNegative", "[PricePerNight] >= 0");
                    table.CheckConstraint("CK_Hotel_StarRating_InRange", "[StarRating] BETWEEN 1 AND 5");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalPrice = table.Column<decimal>(type: "decimal(34,2)", nullable: false),
                    DiscountedPrice = table.Column<decimal>(type: "decimal(34,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPrice = table.Column<decimal>(type: "decimal(34,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_reservation_NumberOfRooms_Positive", "[NumberOfRooms] > 0");
                    table.CheckConstraint("CK_reservation_TotalPrice_NonNegative", "[TotalPrice] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Room_AdultsCapacity_NonNegative", "[AdultsCapacity] >= 0");
                    table.CheckConstraint("CK_Room_ChildrenCapacity_NonNegative", "[ChildrenCapacity] >= 0");
                    table.CheckConstraint("CK_Room_RoomNumber_Positive", "[RoomNumber] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoomReservationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RoomId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReservationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
